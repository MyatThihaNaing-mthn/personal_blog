        ...
        <footer className="fixed w-full py-4 bg-red-500 bottom-0">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <ul className="flex justify-center space-x-6">
                    <li>
                        <a href="https://www.linkedin.com/in/myat-thiha-naing/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-blue-500 transition-colors duration-300">
